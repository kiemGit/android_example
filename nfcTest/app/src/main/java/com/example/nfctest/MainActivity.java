...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText txt_barcode = findViewById(R.id.txt_barcode);
        //Button buttonParse = findViewById(R.id.button_parse);
        txt_barcode.setText("code barcode");
    ...
    private void jsonParse() {
        ...
        String url = "http://119.110.67.113:8005/api/readData";
                ...
                response -> {
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            String firstName = employee.getString("posNama");
                            int age = employee.getInt("posId");
                            String mail = employee.getString("posBarcode");
    ...
    private void resolveIntent(Intent intent) {
        ...
        if (NfcAdapter.ACTION_TAG_DISCOVERED.equals(action)
            ...
            byte[] id = tag.getId();
            //TextView text = findViewById(R.id.txt_barcode);
            ...
            //text.setText(toHex(id));
            //barcode.setText(toReversedHex(id));
            barcode.setText(replaceString);
            //text.setText(detectTagData(tag));
    ...
    private String detectTagData(Tag tag) {
        ...
        byte[] id = tag.getId();
        sb.append("ID a (hex): ").append(toHex(id)).append('\n');
        sb.append("ID b (reversed hex): ").append(toReversedHex(id)).append('\n');
        sb.append("ID c (dec): ").append(toDec(id)).append('\n');
        sb.append("ID d (reversed dec): ").append(toReversedDec(id)).append('\n');
